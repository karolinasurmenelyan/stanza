...
def build_optimizer(args, model, build_simple_adadelta=False):
    ...
    if bert_finetune:
        ...
        if len(bert_parameters) > 0:
            parameters.append({'param_group_name': 'bert', 'params': bert_parameters, 'lr': learning_rate * args['bert_learning_rate'], 'weight_decay': weight_decay * args['bert_weight_decay']})
